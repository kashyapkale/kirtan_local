...
class RestAPIServices implements IKirthanRestApi {
  ...
  Future<bool> deleteUserRequest(Map<String, dynamic> processrequestmap) async {
    ...
    var response = await _client.put('$_baseUrl/submitdeleteuserrequest',
        headers: {"Content-Type": "application/json"}, body: requestBody);
...
*/
  ...
  Future<bool> deleteEventRequest(
    ...
    var response = await _client.put('$_baseUrl/submitdeleteeventrequest',
        headers: {"Content-Type": "application/json"}, body: requestBody);
  ...
  Future<bool> deleteTeamRequest(Map<String, dynamic> processrequestmap) async {
    ...
    var response = await _client.put('$_baseUrl/submitdeleteteamrequest',
        headers: {"Content-Type": "application/json"}, body: requestBody);
